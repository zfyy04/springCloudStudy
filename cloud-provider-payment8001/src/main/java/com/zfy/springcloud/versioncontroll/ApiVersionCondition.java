...
public class ApiVersionCondition implements RequestCondition<ApiVersionCondition> {
    ...
    /**
     * @param reqCondition 请求条件
     * @return ApiVersionCondition
     */
    @Override
    public ApiVersionCondition combine(ApiVersionCondition reqCondition) {
        return new ApiVersionCondition(reqCondition.apiVersion);
    }
